...
if __name__ == '__main__':
    ...
    img_test = osp.join(PATH_IMGS, 'LID', f'{idx}.png')
    ...
    WIDTH_GAP=180
    HEIGHT_GAP=100
    img = img[HEIGHT_GAP+10:-HEIGHT_GAP-10,WIDTH_GAP+48:-WIDTH_GAP,:]
    ...
    for img_idx in range(start_idx, end_idx):
        print(f"{img_idx}")
        image_file = osp.join(PATH_IMGS, 'LID', )
