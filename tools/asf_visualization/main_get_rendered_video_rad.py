...
if __name__ == '__main__':
    ...
    img_test = osp.join(PATH_IMGS, 'RAD', f'{idx}.png')
    ...
    WIDTH_GAP=100
    HEIGHT_GAP=60
    img = img[HEIGHT_GAP+15:-HEIGHT_GAP-10,WIDTH_GAP+150:-WIDTH_GAP-400,:]
    ...
    for img_idx in range(start_idx, end_idx):
        print(f"{img_idx}")
        image_file = osp.join(PATH_IMGS, 'RAD', )
