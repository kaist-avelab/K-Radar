...
All technologies in this repository are owned and developed by [`AVELab`](http://ave.kaist.ac.kr/) and are commercialized by `Zeta Mobility`. For commercialization inquiries, please contact `Zeta Mobility` (e-mail: hyunseok.lee@zetamobility.com & skong@kaist.ac.kr).
